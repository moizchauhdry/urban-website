  ...
  return (
    <div className="booking-card booking-card--shell" aria-hidden="true">
      ...
      <div className="form-grid">
        ...
        <div className="form-group">
          <label>Pick-up*</label>
          <input type="text" readOnly tabIndex={-1} placeholder="Search pick-up address" defaultValue="" />
        </div>
        <div className="form-group">
          <label>Destination*</label>
          <input type="text" readOnly tabIndex={-1} placeholder="Search destination address" defaultValue="" />
        </div>
        <div className="form-group">
