...
import { REVIEWS } from '../connecticut/reviews/reviews.js'
import ReviewsCarousel from '../../components/carousels/ReviewsCarousel.jsx'
import trustPilot from '../../assets/fleet/reviews/trust-pilot.svg'
import googleIcon from '../../assets/fleet/reviews/google.svg'
...
/** Reviews block on the dedicated fleet page. */
export default function FleetReviewsSection() {
  const perView = usePerView()
  const pages = useMemo(() => chunkReviews(REVIEWS, perView), [perView])

  return (
    <section className="section fleet-page-reviews">
      <div className="container">
        <div className="reviews-head">
          ...
          <div className="reviews-rating">
            <strong className="reviews-rating-score">4.8/5</strong>
            <img
