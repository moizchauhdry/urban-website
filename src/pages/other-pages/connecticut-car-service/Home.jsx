...
export default function Home() {
  ...
  return (
    <>
      <LandingHero pageKey="connecticut-car-service" />
      <FleetSection />
      <WhyDifferentSection />
      <PlanningBanner />
      <ReviewsSection />
      <ServicesSection imagePrefix="op-connecticut-car-service" />
      <RouteCardsSection pageKey="connecticut-car-service" />
      <TrustedStats />
      <HowItWorks />
      <JourneySection />
      <RegionalAirportsSection pageKey="other-pages/connecticut-car-service" />
      <FaqSection />
    </>
  )
}
