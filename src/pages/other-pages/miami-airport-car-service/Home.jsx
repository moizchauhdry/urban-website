...
/** Miami Airport Car Service landing page. */
export default function Home() {

  return (
    <>
      <LandingHero pageKey="miami-airport-car-service" />
      <FleetSection />
      <WhyDifferentSection />
      <PlanningBanner />
      <ReviewsSection />
      <ServicesSection imagePrefix="op-miami-airport-car-service" />
      <RouteCardsSection pageKey="miami-airport-car-service" />
      <TrustedStats />
      <HowItWorks />
      <JourneySection />
      <RegionalAirportsSection pageKey="other-pages/miami-airport-car-service" />
      <FaqSection />
    </>
  )
}
