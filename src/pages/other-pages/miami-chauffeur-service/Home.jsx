...
/** Miami Chauffeur Service landing page. */
export default function Home() {

  return (
    <>
      <LandingHero pageKey="miami-chauffeur-service" />
      <FleetSection />
      <WhyDifferentSection />
      <PlanningBanner />
      <ReviewsSection />
      <ServicesSection imagePrefix="op-miami-chauffeur-service" />
      <RouteCardsSection pageKey="miami-chauffeur-service" />
      <TrustedStats />
      <HowItWorks />
      <JourneySection />
      <RegionalAirportsSection pageKey="other-pages/miami-chauffeur-service" />
      <FaqSection />
    </>
  )
}
