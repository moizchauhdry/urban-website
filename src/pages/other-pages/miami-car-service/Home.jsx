...
/** Miami Car Service landing page. */
export default function Home() {

  return (
    <>
      <LandingHero pageKey="miami-car-service" />
      <FleetSection />
      <WhyDifferentSection />
      <PlanningBanner />
      <ReviewsSection />
      <ServicesSection imagePrefix="op-miami-car-service" />
      <RouteCardsSection pageKey="miami-car-service" />
      <TrustedStats />
      <HowItWorks />
      <JourneySection />
      <RegionalAirportsSection pageKey="other-pages/miami-car-service" />
      <FaqSection />
    </>
  )
}
