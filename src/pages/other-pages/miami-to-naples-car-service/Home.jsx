...
export default function Home() {
  ...
  return (
    <>
      <LandingHero pageKey="miami-to-naples-car-service" />
      <FleetSection />
      <WhyDifferentSection />
      <PlanningBanner />
      <ReviewsSection />
      <ServicesSection imagePrefix="op-miami-to-naples-car-service" />
      <RouteCardsSection pageKey="miami-to-naples-car-service" />
      <TrustedStats />
      <HowItWorks />
      <JourneySection />
      <RegionalAirportsSection pageKey="other-pages/miami-to-naples-car-service" />
      <FaqSection />
    </>
  )
}
