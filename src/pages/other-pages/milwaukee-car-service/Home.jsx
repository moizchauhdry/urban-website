...
/** Milwaukee Car Service landing page. */
export default function Home() {

  return (
    <>
      <LandingHero pageKey="milwaukee-car-service" />
      <FleetSection />
      <WhyDifferentSection />
      <PlanningBanner />
      <ReviewsSection />
      <ServicesSection imagePrefix="op-milwaukee-car-service" />
      <RouteCardsSection pageKey="milwaukee-car-service" />
      <TrustedStats />
      <HowItWorks />
      <JourneySection />
      <RegionalAirportsSection pageKey="other-pages/milwaukee-car-service" />
      <FaqSection />
    </>
  )
}
