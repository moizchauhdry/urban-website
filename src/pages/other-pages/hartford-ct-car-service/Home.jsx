...
/** Hartford CT Car Service landing page. */
export default function Home() {

  return (
    <>
      <LandingHero pageKey="hartford-ct-car-service" />
      <FleetSection />
      <WhyDifferentSection />
      <PlanningBanner />
      <ReviewsSection />
      <ServicesSection imagePrefix="op-hartford-ct-car-service" />
      <RouteCardsSection pageKey="hartford-ct-car-service" />
      <TrustedStats />
      <HowItWorks />
      <JourneySection />
      <RegionalAirportsSection pageKey="other-pages/hartford-ct-car-service" />
      <FaqSection />
    </>
  )
}
