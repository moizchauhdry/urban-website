...
export default function Home() {
  ...
  return (
    <>
      <LandingHero pageKey="west-palm-beach-to-miami-limo-service" />
      <FleetSection />
      <WhyDifferentSection />
      <PlanningBanner />
      <ReviewsSection />
      <ServicesSection imagePrefix="op-west-palm-beach-to-miami-limo-service" />
      <RouteCardsSection pageKey="west-palm-beach-to-miami-limo-service" />
      <TrustedStats />
      <HowItWorks />
      <JourneySection />
      <RegionalAirportsSection pageKey="other-pages/west-palm-beach-to-miami-limo-service" />
      <FaqSection />
    </>
  )
}
