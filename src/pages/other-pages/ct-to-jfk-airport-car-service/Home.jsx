...
/** CT to JFK Airport Car Service landing page. */
export default function Home() {

  return (
    <>
      <LandingHero pageKey="ct-to-jfk-airport-car-service" />
      <FleetSection />
      <WhyDifferentSection />
      <PlanningBanner />
      <ReviewsSection />
      <ServicesSection imagePrefix="op-ct-to-jfk-airport-car-service" />
      <RouteCardsSection pageKey="ct-to-jfk-airport-car-service" />
      <TrustedStats />
      <HowItWorks />
      <JourneySection />
      <RegionalAirportsSection pageKey="other-pages/ct-to-jfk-airport-car-service" />
      <FaqSection />
    </>
  )
}
