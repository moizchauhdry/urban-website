...
/** BDL Airport Car Service landing page. */
export default function Home() {

  return (
    <>
      <LandingHero pageKey="bdl-airport-car-service" />
      <FleetSection />
      <WhyDifferentSection />
      <PlanningBanner />
      <ReviewsSection />
      <ServicesSection imagePrefix="op-bdl-airport-car-service" />
      <RouteCardsSection pageKey="bdl-airport-car-service" />
      <TrustedStats />
      <HowItWorks />
      <JourneySection />
      <RegionalAirportsSection pageKey="other-pages/bdl-airport-car-service" />
      <FaqSection />
    </>
  )
}
