...
/** JFK Airport Car Service landing page. */
export default function Home() {

  return (
    <>
      <LandingHero pageKey="jfk-airport-car-service" />
      <FleetSection />
      <WhyDifferentSection />
      <PlanningBanner />
      <ReviewsSection />
      <ServicesSection imagePrefix="op-jfk-airport-car-service" />
      <RouteCardsSection pageKey="jfk-airport-car-service" />
      <TrustedStats />
      <HowItWorks />
      <JourneySection />
      <RegionalAirportsSection pageKey="other-pages/jfk-airport-car-service" />
      <FaqSection />
    </>
  )
}
