...
/** Florida Car Service landing page. */
export default function Home() {

  return (
    <>
      <LandingHero pageKey="florida-car-service" />
      <FleetSection />
      <WhyDifferentSection />
      <PlanningBanner />
      <ReviewsSection />
      <ServicesSection imagePrefix="op-florida-car-service" />
      <RouteCardsSection pageKey="florida-car-service" />
      <TrustedStats />
      <HowItWorks />
      <JourneySection />
      <RegionalAirportsSection pageKey="other-pages/florida-car-service" />
      <FaqSection />
    </>
  )
}
