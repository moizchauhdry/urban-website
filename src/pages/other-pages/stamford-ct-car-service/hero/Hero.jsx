...
/** Stamford CT Car Service hero + booking card */
      ...
      <div className="container">
        <div className="hero-content">
          ...
          <h1 className="hero-title">
            <span className="hero-title-line hero-title-line--highlight">{"Stamford CT"}</span>{' '}
            <span className="hero-title-line">{"Car Service"}</span>
          </h1>
          <p className="hero-desc">
            Travel in comfort with {"Stamford CT Car Service"} designed for people who want a smooth and stress free
            ...
            Your ride stays simple, safe and well planned throughout {"Stamford CT"}.
          </p>
