...
/** Stamford CT Car Service landing page. */
export default function Home() {

  return (
    <>
      <LandingHero pageKey="stamford-ct-car-service" />
      <FleetSection />
      <WhyDifferentSection />
      <PlanningBanner />
      <ReviewsSection />
      <ServicesSection imagePrefix="op-stamford-ct-car-service" />
      <RouteCardsSection pageKey="stamford-ct-car-service" />
      <TrustedStats />
      <HowItWorks />
      <JourneySection />
      <RegionalAirportsSection pageKey="other-pages/stamford-ct-car-service" />
      <FaqSection />
    </>
  )
}
