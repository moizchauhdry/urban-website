...
/** Miami to Orlando Car Service landing page. */
export default function Home() {

  return (
    <>
      <LandingHero pageKey="miami-to-orlando-car-service" />
      <FleetSection />
      <WhyDifferentSection />
      <PlanningBanner />
      <ReviewsSection />
      <ServicesSection imagePrefix="op-miami-to-orlando-car-service" />
      <RouteCardsSection pageKey="miami-to-orlando-car-service" />
      <TrustedStats />
      <HowItWorks />
      <JourneySection />
      <RegionalAirportsSection pageKey="other-pages/miami-to-orlando-car-service" />
      <FaqSection />
    </>
  )
}
