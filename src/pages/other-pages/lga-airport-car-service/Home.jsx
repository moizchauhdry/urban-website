...
/** LGA Airport Car Service landing page. */
export default function Home() {

  return (
    <>
      <LandingHero pageKey="lga-airport-car-service" />
      <FleetSection />
      <WhyDifferentSection />
      <PlanningBanner />
      <ReviewsSection />
      <ServicesSection imagePrefix="op-lga-airport-car-service" />
      <RouteCardsSection pageKey="lga-airport-car-service" />
      <TrustedStats />
      <HowItWorks />
      <JourneySection />
      <RegionalAirportsSection pageKey="other-pages/lga-airport-car-service" />
      <FaqSection />
    </>
  )
}
