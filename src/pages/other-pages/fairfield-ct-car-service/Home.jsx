...
/** Fairfield CT Car Service landing page. */
export default function Home() {

  return (
    <>
      <LandingHero pageKey="fairfield-ct-car-service" />
      <FleetSection />
      <WhyDifferentSection />
      <PlanningBanner />
      <ReviewsSection />
      <ServicesSection imagePrefix="op-fairfield-ct-car-service" />
      <RouteCardsSection pageKey="fairfield-ct-car-service" />
      <TrustedStats />
      <HowItWorks />
      <JourneySection />
      <RegionalAirportsSection pageKey="other-pages/fairfield-ct-car-service" />
      <FaqSection />
    </>
  )
}
