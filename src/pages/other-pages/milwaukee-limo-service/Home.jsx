...
/** Milwaukee Limo Service landing page. */
export default function Home() {

  return (
    <>
      <LandingHero pageKey="milwaukee-limo-service" />
      <FleetSection />
      <WhyDifferentSection />
      <PlanningBanner />
      <ReviewsSection />
      <ServicesSection imagePrefix="op-milwaukee-limo-service" />
      <RouteCardsSection pageKey="milwaukee-limo-service" />
      <TrustedStats />
      <HowItWorks />
      <JourneySection />
      <RegionalAirportsSection pageKey="other-pages/milwaukee-limo-service" />
      <FaqSection />
    </>
  )
}
