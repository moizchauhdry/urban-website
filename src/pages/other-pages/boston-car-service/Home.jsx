...
/** Boston Car Service landing page. */
export default function Home() {

  return (
    <>
      <LandingHero pageKey="boston-car-service" />
      <FleetSection />
      <WhyDifferentSection />
      <PlanningBanner />
      <ReviewsSection />
      <ServicesSection imagePrefix="op-boston-car-service" />
      <RouteCardsSection pageKey="boston-car-service" />
      <TrustedStats />
      <HowItWorks />
      <JourneySection />
      <RegionalAirportsSection pageKey="other-pages/boston-car-service" />
      <FaqSection />
    </>
  )
}
