import economySedan from '../../../../assets/illinois/illinois/fleet/economy-sedan.webp'
import firstClassSedan from '../../../../assets/illinois/illinois/fleet/first-class-sedan.webp'
import luxurySedan from '../../../../assets/illinois/illinois/fleet/luxury-sedan.webp'
import fullSizeSuv from '../../../../assets/illinois/illinois/fleet/full-size-suv.webp'
import limo from '../../../../assets/illinois/illinois/fleet/limo-final.webp'
import sprinter from '../../../../assets/illinois/illinois/fleet/sprinter.webp'
import partyBus from '../../../../assets/illinois/illinois/fleet/party-bus.webp'
import motorCoach from '../../../../assets/illinois/illinois/fleet/moto-coach.webp'
...
export const fleetItems = [
  {
    ...
    images: [
      ...
      {
        loadSrc: () => import('../../../../assets/illinois/illinois/fleet/economy-sedan2.webp'),
        alt: 'Economy Sedan — gallery 2 of 3',
      },
      {
        loadSrc: () => import('../../../../assets/illinois/illinois/fleet/economy-sedan3.webp'),
  ...
  },
  {
    ...
    images: [
      ...
      {
        loadSrc: () => import('../../../../assets/illinois/illinois/fleet/first-class-sedan2.webp'),
        alt: 'First Class Sedan — gallery 2 of 3',
      },
      {
        loadSrc: () => import('../../../../assets/illinois/illinois/fleet/first-class-sedan3.webp'),
  ...
  },
  {
    ...
    images: [
      ...
      {
        loadSrc: () => import('../../../../assets/illinois/illinois/fleet/luxury-sedan2.webp'),
        alt: 'Luxury Sedan — gallery 2 of 3',
      },
      {
        loadSrc: () => import('../../../../assets/illinois/illinois/fleet/luxury-sedan3.webp'),
  ...
  },
  {
    ...
    images: [
      ...
      {
        loadSrc: () => import('../../../../assets/illinois/illinois/fleet/full-size-suv2.webp'),
        alt: 'Full Size SUV — gallery 2 of 3',
      },
      {
        loadSrc: () => import('../../../../assets/illinois/illinois/fleet/full-size-suv3.webp'),
  ...
  },
  {
    ...
    images: [
      ...
      {
        loadSrc: () => import('../../../../assets/illinois/illinois/fleet/limo2.webp'),
        alt: 'Limousine — gallery 2 of 3',
      },
      {
        loadSrc: () => import('../../../../assets/illinois/illinois/fleet/limo3.webp'),
  ...
  },
  {
    ...
    images: [
      ...
      {
        loadSrc: () => import('../../../../assets/illinois/illinois/fleet/sprinter2.webp'),
        alt: 'Sprinter Van — gallery 2 of 3',
      },
      {
        loadSrc: () => import('../../../../assets/illinois/illinois/fleet/sprinter3.webp'),
  ...
  },
  {
    ...
    images: [
      ...
      {
        loadSrc: () => import('../../../../assets/illinois/illinois/fleet/party-bus2.webp'),
        alt: 'Party Bus — gallery 2 of 3',
      },
      {
        loadSrc: () => import('../../../../assets/illinois/illinois/fleet/party-bus3.webp'),
  ...
  },
  {
    ...
    images: [
      ...
      {
        loadSrc: () => import('../../../../assets/illinois/illinois/fleet/moto-coach2.webp'),
