...
/** New York Car Service landing page. */
export default function Home() {

  return (
    <>
      <LandingHero pageKey="new-york-car-service" />
      <FleetSection />
      <WhyDifferentSection />
      <PlanningBanner />
      <ReviewsSection />
      <ServicesSection imagePrefix="op-new-york-car-service" />
      <RouteCardsSection pageKey="new-york-car-service" />
      <TrustedStats />
      <HowItWorks />
      <JourneySection />
      <RegionalAirportsSection pageKey="other-pages/new-york-car-service" />
      <FaqSection />
    </>
  )
}
