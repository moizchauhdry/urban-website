...
/** Norwalk CT Car Service landing page. */
export default function Home() {

  return (
    <>
      <LandingHero pageKey="norwalk-ct-car-service" />
      <FleetSection />
      <WhyDifferentSection />
      <PlanningBanner />
      <ReviewsSection />
      <ServicesSection imagePrefix="op-norwalk-ct-car-service" />
      <RouteCardsSection pageKey="norwalk-ct-car-service" />
      <TrustedStats />
      <HowItWorks />
      <JourneySection />
      <RegionalAirportsSection pageKey="other-pages/norwalk-ct-car-service" />
      <FaqSection />
    </>
  )
}
