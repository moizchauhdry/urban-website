...
/** Wisconsin Car Service landing page. */
export default function Home() {

  return (
    <>
      <LandingHero pageKey="wisconsin-car-service" />
      <FleetSection />
      <WhyDifferentSection />
      <PlanningBanner />
      <ReviewsSection />
      <ServicesSection imagePrefix="op-wisconsin-car-service" />
      <RouteCardsSection pageKey="wisconsin-car-service" />
      <TrustedStats />
      <HowItWorks />
      <JourneySection />
      <RegionalAirportsSection pageKey="other-pages/wisconsin-car-service" />
      <FaqSection />
    </>
  )
}
