...
/** Danbury CT Car Service landing page. */
export default function Home() {

  return (
    <>
      <LandingHero pageKey="danbury-ct-car-service" />
      <FleetSection />
      <WhyDifferentSection />
      <PlanningBanner />
      <ReviewsSection />
      <ServicesSection imagePrefix="op-danbury-ct-car-service" />
      <RouteCardsSection pageKey="danbury-ct-car-service" />
      <TrustedStats />
      <HowItWorks />
      <JourneySection />
      <RegionalAirportsSection pageKey="other-pages/danbury-ct-car-service" />
      <FaqSection />
    </>
  )
}
