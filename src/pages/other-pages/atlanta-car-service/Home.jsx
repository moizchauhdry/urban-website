...
/** Atlanta Car Service landing page. */
export default function Home() {

  return (
    <>
      <LandingHero pageKey="atlanta-car-service" />
      <FleetSection />
      <WhyDifferentSection />
      <PlanningBanner />
      <ReviewsSection />
      <ServicesSection imagePrefix="op-atlanta-car-service" />
      <RouteCardsSection pageKey="atlanta-car-service" />
      <TrustedStats />
      <HowItWorks />
      <JourneySection />
      <RegionalAirportsSection pageKey="other-pages/atlanta-car-service" />
      <FaqSection />
    </>
  )
}
