import economySedan from '../../../../assets/illinois/ohare-intl-airport-ord-limo-service/fleet/economy-sedan.webp'
...
export const fleetItems = [
  {
    ...
    images: [
      ...
      {
        loadSrc: () => import('../../../../assets/illinois/ohare-intl-airport-ord-limo-service/fleet/economy-sedan2.webp'),
        alt: 'Economy Sedan — gallery 2 of 3',
      },
      {
        loadSrc: () => import('../../../../assets/illinois/ohare-intl-airport-ord-limo-service/fleet/economy-sedan3.webp'),
