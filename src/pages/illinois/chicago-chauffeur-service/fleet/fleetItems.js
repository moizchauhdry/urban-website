import economySedan from '../../../../assets/illinois/chicago-chauffeur-service/fleet/economy-sedan.webp'
import firstClassSedan from '../../../../assets/illinois/chicago-chauffeur-service/fleet/first-class-sedan.webp'
import luxurySedan from '../../../../assets/illinois/chicago-chauffeur-service/fleet/luxury-sedan.webp'
import fullSizeSuv from '../../../../assets/illinois/chicago-chauffeur-service/fleet/full-size-suv.webp'
import limo from '../../../../assets/illinois/chicago-chauffeur-service/fleet/limo-final.webp'
import sprinter from '../../../../assets/illinois/chicago-chauffeur-service/fleet/sprinter.webp'
import partyBus from '../../../../assets/illinois/chicago-chauffeur-service/fleet/party-bus.webp'
import motorCoach from '../../../../assets/illinois/chicago-chauffeur-service/fleet/moto-coach.webp'
...
export const fleetItems = [
  {
    ...
    images: [
      ...
      {
        loadSrc: () => import('../../../../assets/illinois/chicago-chauffeur-service/fleet/economy-sedan2.webp'),
        alt: 'Economy Sedan — gallery 2 of 3',
      },
      {
        loadSrc: () => import('../../../../assets/illinois/chicago-chauffeur-service/fleet/economy-sedan3.webp'),
  ...
  },
  {
    ...
    images: [
      ...
      {
        loadSrc: () => import('../../../../assets/illinois/chicago-chauffeur-service/fleet/first-class-sedan2.webp'),
        alt: 'First Class Sedan — gallery 2 of 3',
      },
      {
        loadSrc: () => import('../../../../assets/illinois/chicago-chauffeur-service/fleet/first-class-sedan3.webp'),
  ...
  },
  {
    ...
    images: [
      ...
      {
        loadSrc: () => import('../../../../assets/illinois/chicago-chauffeur-service/fleet/luxury-sedan2.webp'),
        alt: 'Luxury Sedan — gallery 2 of 3',
      },
      {
        loadSrc: () => import('../../../../assets/illinois/chicago-chauffeur-service/fleet/luxury-sedan3.webp'),
  ...
  },
  {
    ...
    images: [
      ...
      {
        loadSrc: () => import('../../../../assets/illinois/chicago-chauffeur-service/fleet/full-size-suv2.webp'),
        alt: 'Full Size SUV — gallery 2 of 3',
      },
      {
        loadSrc: () => import('../../../../assets/illinois/chicago-chauffeur-service/fleet/full-size-suv3.webp'),
  ...
  },
  {
    ...
    images: [
      ...
      {
        loadSrc: () => import('../../../../assets/illinois/chicago-chauffeur-service/fleet/limo2.webp'),
        alt: 'Limousine — gallery 2 of 3',
      },
      {
        loadSrc: () => import('../../../../assets/illinois/chicago-chauffeur-service/fleet/limo3.webp'),
  ...
  },
  {
    ...
    images: [
      ...
      {
        loadSrc: () => import('../../../../assets/illinois/chicago-chauffeur-service/fleet/sprinter2.webp'),
        alt: 'Sprinter Van — gallery 2 of 3',
      },
      {
        loadSrc: () => import('../../../../assets/illinois/chicago-chauffeur-service/fleet/sprinter3.webp'),
  ...
  },
  {
    ...
    images: [
      ...
      {
        loadSrc: () => import('../../../../assets/illinois/chicago-chauffeur-service/fleet/party-bus2.webp'),
        alt: 'Party Bus — gallery 2 of 3',
      },
      {
        loadSrc: () => import('../../../../assets/illinois/chicago-chauffeur-service/fleet/party-bus3.webp'),
  ...
  },
  {
    ...
    images: [
      ...
      {
        loadSrc: () => import('../../../../assets/illinois/chicago-chauffeur-service/fleet/moto-coach2.webp'),
