...
export default function Header() {
  const onHomeLogoClick = useHomeLogoClick(CHICAGO_LIMO_HOME)
  ...
  return (
    ...
    >
      <div className="container nav">
        <Link to={CHICAGO_LIMO_HOME} className="logo" onClick={onHomeLogoClick}>
          <HeaderBrandLogo />
          </Link>
        <Navbar />
        <HeaderBookNow homePath={CHICAGO_LIMO_HOME} />
        <button
          type="button"
