...
export default function Header() {
  const onHomeLogoClick = useHomeLogoClick(CHICAGO_AIRPORT_CAR_HOME)
  ...
  return (
    ...
    >
      <div className="container nav">
        <Link to={CHICAGO_AIRPORT_CAR_HOME} className="logo" onClick={onHomeLogoClick}>
          <HeaderBrandLogo />
          </Link>
        <Navbar />
        <HeaderBookNow homePath={CHICAGO_AIRPORT_CAR_HOME} />
        <button
          type="button"
