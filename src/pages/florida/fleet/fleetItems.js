import economySedan from '../../../assets/florida/fleet/economy-sedan.webp'
import firstClassSedan from '../../../assets/florida/fleet/first-class-sedan.webp'
import luxurySedan from '../../../assets/florida/fleet/luxury-sedan.webp'
import fullSizeSuv from '../../../assets/florida/fleet/full-size-suv.webp'
import limo from '../../../assets/florida/fleet/limo-final.webp'
import sprinter from '../../../assets/florida/fleet/sprinter.webp'
import partyBus from '../../../assets/florida/fleet/party-bus.webp'
import motorCoach from '../../../assets/florida/fleet/moto-coach.webp'
...
export const fleetItems = [
  {
    ...
    images: [
      ...
      {
        loadSrc: () => import('../../../assets/florida/fleet/economy-sedan2.webp'),
        alt: 'Economy Sedan — gallery 2 of 3',
      },
      {
        loadSrc: () => import('../../../assets/florida/fleet/economy-sedan3.webp'),
  ...
  },
  {
    ...
    images: [
      ...
      {
        loadSrc: () => import('../../../assets/florida/fleet/first-class-sedan2.webp'),
        alt: 'First Class Sedan — gallery 2 of 3',
      },
      {
        loadSrc: () => import('../../../assets/florida/fleet/first-class-sedan3.webp'),
  ...
  },
  {
    ...
    images: [
      ...
      {
        loadSrc: () => import('../../../assets/florida/fleet/luxury-sedan2.webp'),
        alt: 'Luxury Sedan — gallery 2 of 3',
      },
      {
        loadSrc: () => import('../../../assets/florida/fleet/luxury-sedan3.webp'),
  ...
  },
  {
    ...
    images: [
      ...
      {
        loadSrc: () => import('../../../assets/florida/fleet/full-size-suv2.webp'),
        alt: 'Full Size SUV — gallery 2 of 3',
      },
      {
        loadSrc: () => import('../../../assets/florida/fleet/full-size-suv3.webp'),
  ...
  },
  {
    ...
    images: [
      ...
      {
        loadSrc: () => import('../../../assets/florida/fleet/limo2.webp'),
        alt: 'Limousine — gallery 2 of 3',
      },
      {
        loadSrc: () => import('../../../assets/florida/fleet/limo3.webp'),
  ...
  },
  {
    ...
    images: [
      ...
      {
        loadSrc: () => import('../../../assets/florida/fleet/sprinter2.webp'),
        alt: 'Sprinter Van — gallery 2 of 3',
      },
      {
        loadSrc: () => import('../../../assets/florida/fleet/sprinter3.webp'),
  ...
  },
  {
    ...
    images: [
      ...
      {
        loadSrc: () => import('../../../assets/florida/fleet/party-bus2.webp'),
        alt: 'Party Bus — gallery 2 of 3',
      },
      {
        loadSrc: () => import('../../../assets/florida/fleet/party-bus3.webp'),
  ...
  },
  {
    ...
    images: [
      ...
      {
        loadSrc: () => import('../../../assets/florida/fleet/moto-coach2.webp'),
